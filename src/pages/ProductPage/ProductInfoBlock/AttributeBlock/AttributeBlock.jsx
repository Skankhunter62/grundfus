  ...
  return (
    <div className={classes.attributesBlock}>
      ...
      {singleProduct.attributes.map((element, index) =>
        index === 0 || index === 1 ? (
          <div className={classes.singleAttribute} key={element.name}>
            {" "}
            <div className={classes.attributesText}>{element.name}</div>{" "}
            <div className={classes.attributesText}>{element.options[0]}</div>{" "}
          </div>
        ) : null
      )}
    </div>
