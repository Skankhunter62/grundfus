...
import classes from "./TestProductLoopAsideFilters.module.css";
...
import ProductLoopAsideFilterAttribute from "./TestProductLoopAsideFilterAttribute/TestProductLoopAsideFilterAttribute";
import { current } from "@reduxjs/toolkit";

const TestProductLoopAsideFilters = ({
  removeFilters,
  changeEmptyFlag,
  changeNotFound,
  emptyProducts = false,
...
export default TestProductLoopAsideFilters;
