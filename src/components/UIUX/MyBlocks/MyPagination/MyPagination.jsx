...
const MyPagination = ({nPages, currentPage, setCurrentPage}) => {
    ...
    const prevPage = () => {if(currentPage !== nPages){setCurrentPage(currentPage - 1)}}

    return (
        <ul className={classes.paginationBlock}>
            <li className={classes.arrowStyle}> <img src={prev_arrow} alt="" onClick={prevPage}/> </li>
            {
            ...
            <li className={classes.arrowStyle}> <img src={next_arrow} alt="" onClick={nextPage}/> </li>
        </ul>
    );
};
