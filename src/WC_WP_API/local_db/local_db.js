...
export const subMenu = [
    {id: 1, title: 'Комплектующие', link:'/catalog'},
...
export const attributesDefaultList = [
    ...
    {id: 30, name: "Max рабочее давление (бар)", slug: "pa_max-rabochee-davlenie-bar", options: []},
    {id: 33, name: "Размеры (ШхВхД)", slug: "pa_razmery-shhvhd", options: []},
    {id: 31, name: "Максимальный напор", slug: "pa_maksimalnyj-napor", options: []},
    {id: 28, name: "Пропуск. способность (куб.\\/час)", slug: "pa_propusk-sposobnost-kub-chas", options: []},
    {id: 32, name: "Установка насоса", slug: "pa_ustanovka-nasosa", options: []},
