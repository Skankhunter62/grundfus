...
import classes from './ProductLoopAsideRemoveFilters.module.css'
...
const ProductLoopAsideRemoveFilters = ({changeRemoveFilter}) => {
...
export default ProductLoopAsideRemoveFilters;