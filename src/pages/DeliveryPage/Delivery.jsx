...
const Delivery = () => {
        ...
        <div className={classes.main_container}>
            <Helmet>
                ...
                <meta property="og:title" content="Способы доставки | Grundfos-Moscow.ru"/>
                <meta name="description" content="Как получить заказ и какие документы для этого нужны."/>
                <meta property="og:description" content="Как получить заказ и какие документы для этого нужны."/>
